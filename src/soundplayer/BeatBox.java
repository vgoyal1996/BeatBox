...
public class BeatBox {
	...
	Track track;
	JFrame theFrame;
	String instrumentNames[]={"Bass Drums","Closed Hi-Hat","Open Hi-Hat","Acoustic Snare",
	...
	public void buildGUI(){
		...
		JButton serialit = new JButton("Serialize");
		serialit.addActionListener(new MySendListener());
		buttonBox.add(serialit);
